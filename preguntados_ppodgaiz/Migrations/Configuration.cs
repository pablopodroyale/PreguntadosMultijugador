namespace preguntados_ppodgaiz.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<preguntados_ppodgaiz.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(preguntados_ppodgaiz.Models.ApplicationDbContext context)
        {
            //Roles
